...
# #     • topping_type: str - if the topping is an empty string, raise a ValueError with message "The topping type cannot be an empty string"
# #     • weight: float - if the weight is 0 or less, raise a ValueError with message "The weight cannot be less or equal to zero"
