...
print(space_station.add_planet("Burgas", "Batki, Kaki, More, Bira, Batki, Kaki, More, Bira, Batki, Kaki, More, Bira, Kaki, More, Bira, Batki,"))
print(space_station.send_on_mission("Burgas"))
