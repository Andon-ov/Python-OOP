...
class BaseAquarium(abc.ABC):
    ...
    @name.setter
    def name(self, value):
        Validator.cannot_be_empty_string(value, "Aquarium name cannot be an empty string.")
        self.__name = value
    ...
    def add_fish(self, fish):
        ...
        if self.__class__.__name__ != fish.could_only_live_in:
    ...
    def __str__(self):
        fish = "none" if len(self.fish) == 0 else ' '.join([x.name for x in self.fish])
